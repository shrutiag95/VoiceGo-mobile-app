...
import com.recyclerinfragment.Fragments.Recycler.MyRecyclerAdapter;
...
public class Frag3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v =inflater.inflate(R.layout.frag_following,null);
        //Recycler View
        final RecyclerView rv = (RecyclerView)v.findViewById(R.id.r3);
        rv.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        String view_url = "http://192.168.43.206/shruti/view_following.php";
        ...
        JsonObjectRequest req=new JsonObjectRequest(Request.Method.POST,view_url,null,new Response.Listener<JSONObject>(){
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    followerarray = response.getJSONArray("following");
                ...
                rv.setAdapter(new MyRecyclerAdapter(getActivity(), list));
